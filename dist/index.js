...
var insertReferralSchema = createInsertSchema(referrals).omit({
  ...
  needsAssessment: z.string().min(50, "Please provide detailed information about the needs (at least 50 characters)")
});
...
app.post("/api/referrals", async (req, res) => {
  try {
    ...
    await db.insert(referrals).values({ name, email });
    res.json({ success: true, message: "Referral saved!" });
  } catch (err) {
    console.error(err);
